...
prorok_melodie_sloka_prava = \relative c' {
    \key a \major
    \clef treble
    \language "deutsch"
    \time 4/4
...
prorok_melodie_sloka_leva = \relative c {
    \key a \major
    \clef bass
    \language "deutsch"
    \time 4/4
...
prorok_akordy_sloka = \relative c' \chordmode {
    \semiGermanChords
...
prorok_slova_sloka_a = \lyricmode {
    \set stanza = "1. "
...
prorok_slova_sloka_b = \lyricmode {
    \set stanza = "2. "
...
prorok_slova_sloka_c = \lyricmode {
    \set stanza = "3. "
...
prorok_slova_sloka_d = \lyricmode {
    \set stanza = "4. "
...
prorok_slova_sloka_e = \lyricmode {
    \set stanza = "5. "
...
prorok_sloka_doprovod = \new PianoStaff <<
    \new ChordNames \prorok_akordy_sloka
    \new Staff \prorok_melodie_sloka_prava
    \new Staff \prorok_melodie_sloka_leva
    \new Lyrics \prorok_slova_sloka_a
    \new Lyrics \prorok_slova_sloka_b
    \new Lyrics \prorok_slova_sloka_c
    \new Lyrics \prorok_slova_sloka_d
    \new Lyrics \prorok_slova_sloka_e
>>
