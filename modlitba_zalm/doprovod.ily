\bookpart {
    ...
    \markup {
        \column {
            ...
            \vspace #0.75
            \justify {
                Antifonu zpívá na začátku jednou předzpěvák či sbor, poté ji zopakuje celé shromáždění.
    ...
    \markup { \column {
        ...
        \vspace #0.5 %}
        \justify {
            První verš (řádek) je rozložen do dvou. Po třetí notě se klesá zpět na druhou. Melodie pouze naznačena:
        }
        \vspace #0.5
    } }
    \score {
