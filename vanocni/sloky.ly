...
slova_sloka_ab = \lyricmode {
	teh8 -- dy8 Slo4 -- vo4
	se8 -- sta8 -- lo4 tě4 -- lem2
	"v lů"8 -- ně8 sva4 -- té4
	Ma4 -- ri8 -- e8 Pan4 -- ny.2
}
slova_sloka_ba = \lyricmode {
	\set stanza = "2: "
	Ty8 jsi8 pro4 nás4
...
sloka_doprovod = \new PianoStaff <<
	...
	\new Lyrics \slova_sloka_aa
	\new Lyrics \slova_sloka_ab
>>

sloka_lidi = \new StaffGroup <<
	\new Staff \melodie_sloka_lidi
	\new Lyrics \slova_sloka_aa
	\new Lyrics \slova_sloka_ab
	\new Lyrics \slova_sloka_ba
	\new Lyrics \slova_sloka_bb
	\new Lyrics \slova_sloka_ca
	\new Lyrics \slova_sloka_cb
	\new Lyrics \slova_sloka_da
	\new Lyrics \slova_sloka_db
>>
